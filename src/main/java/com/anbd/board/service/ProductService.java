...
public interface ProductService {
	...
	default ProductEntity toEntity(Product dto) {
		ClientEntity product_seller = ClientEntity.builder().client_id(dto.getProduct_seller()).build();
		ClientEntity product_buyer = ClientEntity.builder().client_id(dto.getProduct_seller()).build();
		CategoryEntity product_category = CategoryEntity.builder().category_name(dto.getProduct_category()).build();
	...
	default Product toDto(ProductEntity entity) {
		return Product.builder()
				...
				.product_category(entity.getProduct_category().getCategory_name())
				...
				.product_seller(entity.getProduct_seller().getClient_id())
				.product_buyer(entity.getProduct_buyer().getClient_id())
