...
public interface Report_ProductService {
	default Report_productEntity toEntity(Report_product dto) {
		...
		ClientEntity report_product_id = ClientEntity.builder().client_id(dto.getReport_product_id()).build();
		...
		return Report_productEntity.builder()
				...
				.report_product_no(report_product_no)
				.report_comment(dto.getReport_comment())
				.build();
	}
	
	default Report_product toDto(Report_productEntity entity) {
		return Report_product.builder().report_product_no(entity.getReport_no())
				.report_id(entity.getReport_id().getClient_id())
				.report_product_id(entity.getReport_product_id().getClient_id())
				.report_product_no(entity.getReport_product_no().getProduct_no())
